...
class ChatManager: NSObject, TwilioChatClientDelegate  {
    // Adding custom channel in future, now just leave default channel for testing
    ...
    private var identity: String = SessionManager.getUsername()
    ...
    private func refreshAccessToken() {
        ...
        let urlString = "\(Constants.TOKEN_URL)?identity=\(identity)"
